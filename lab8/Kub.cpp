...
bool Kub::find(bool kek, int count){
...
void Kub::checkmas(int* mas, unsigned char c){
    if(c == 'y'){
        mas[0]++;
    }else if(c == 'r'){
        mas[1]++;
...
bool Kub::checkcol(unsigned char a, unsigned char b){
...
bool Kub::checkcen(std::vector<unsigned char>& cen, unsigned char a, bool flag, int* mas){
    if(flag == true){
...
bool Kub::checkreb(std::vector<std::pair<unsigned char, unsigned char>>& reb, unsigned char
...
bool Kub::checkcor(std::vector<std::pair<unsigned char, std::pair<unsigned char, unsigned
char>>>&
cor,
...
void Kub::littlecheck(int& count){
    for(int j = 0; j < 9; j++){
