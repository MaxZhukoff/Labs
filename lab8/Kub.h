...
private:
    ...
    bool checkreb(std::vector<std::pair<unsigned char, unsigned char>>& reb, unsigned
    char a, unsigned char b, bool flag, int* mas);
    bool checkcor(std::vector<std::pair<unsigned char, std::pair<unsigned char, unsigned
    char>>>&cor, unsigned char a, unsigned char b, unsigned char c, bool flag, int* mas);
    void goodw(int a);
    void findkrest();
    void krest();
